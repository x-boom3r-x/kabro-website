        ...
        <div className="flex items-center gap-4">
          ...
          <Button asChild variant="gold" size="default" className="relative rounded-full">
            <Link to="/panier" className="relative inline-flex items-center justify-center w-11 h-11 rounded-full border hover:border-primary">
              ...
              {totalCount > 0 && (
                <span className="absolute -top-1 -right-1 min-w-5 h-5 px-1 rounded-full bg-primary text-primary-foreground text-xs font-bold inline-flex items-center justify-center">{totalCount}</span>
              )}
            </Link>
          </Button>
